...
export const scanPrescriptionImage = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const prompt = 'Transcribe this medical prescription exactly. List Patient Name, Date, Medications, and Instructions clearly. If something is unreadable, mark it as [unclear]. Remove any markdown formatting.';
    ...
    console.error('SERVER SIDE SCAN ERROR:', error.message);
